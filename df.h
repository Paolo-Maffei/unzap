...
/* prototypes */
void df_buf_load(df_buf_t, df_page_t);
void df_buf_read(df_buf_t, void*, df_size_t, df_size_t);
void df_buf_write(df_buf_t, void*, df_size_t, df_size_t);
void df_buf_save(df_buf_t, df_page_t);
void df_flash_read(df_page_t, void*, df_size_t, df_size_t);
void df_erase(df_page_t);
